...
function MedBlo() {
  return (
    <>
      <MyClass />
      <br />
      <div className="contai"> {/* Added Bootstrap container to prevent overflow */}
        <div className="ro"> 
          ...
          <article className="blog-post">
              ...
              <p className="blog-post-meta">
                March 8, 2019 by <a href="/">Devjyot Ghoshal</a>
              </p>
            ...
            <article className="blog-post">
              ...
              <p className="blog-post-meta">
                February 7, 2019 by <a href="/">Bishakha Nihalani</a>
              </p>
              <iframe
