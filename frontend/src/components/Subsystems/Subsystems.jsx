...
function Subsytems(){
    return(
        <>
            <MyClass/>
            <h1 style={{marginLeft:"1rem",marginTop:"1rem"}}>Subsystems</h1>
        ...
        <div className="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
          ...
          <div className="row">
            ...
            <div className="col-md-6 px-0">
              <h1 className="display-4 fst-italic">Perception</h1>
        ...
        <div className="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
          ...
          <div className="row">
            ...
            <div className="col-md-6 px-0 py-3">
              <h1 className="display-4 fst-italic">Motion Planning</h1>
              <p className="lead my-3">
      ...
      <div className="position-relative m-3">
        <div className="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
          ...
          <div className="row">
            {/* Text Column */}
            <div className="col-md-6 px-0">
              <h1 className="display-4 fst-italic">Controls</h1>
              <p className="lead my-3">
      ...
      <div className="position-relative m-3">
        <div className="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
          ...
          <div className="row">
            ...
            {/* Text Column */}
            <div className="col-md-6 px-0 py-3">
              <h1 className="display-4 fst-italic">Mechatronics</h1>
              <p className="lead my-3">
      ...
      <div className="position-relative m-3">
        <div className="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
          ...
          <div className="row">
            {/* Text Column */}
            <div className="col-md-6 px-0">
              <h1 className="display-4 fst-italic">Communications</h1>
              <p className="lead my-3">
