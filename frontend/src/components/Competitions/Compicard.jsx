        ...
        <div className="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
          ...
          <div className="row">
            ...
            <div className="col-md-6 px-0">
              <h1 className="display-4 fst-italic">Student Design Challenge</h1>
      ...
      <div className="position-relative m-3">
        <div className="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
          ...
          <div className="row">
            {/* Text Column */}
            <div className="col-md-6 px-0">
              <h1 className="display-4 fst-italic">IGVC Auto Nav</h1>
              <p className="lead my-3">
            ...
            <div className="col-md-6 card-right">
              <div className="d-flex justify-content-center  h-100">
                <img src={auto} alt="Competition" className="img-fluid" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="position-relative m-3">
        <div className="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
          ...
          <div className="row">
            {/* Text Column */}
            <div className="col-md-6 px-0">
              <h1 className="display-4 fst-italic">Mahindra Rise Challenge</h1>
              <p className="lead my-3">
            ...
            <div className="col-md-6 card-right">
              <div className="d-flex justify-content-center  h-100">
                <img src={rise} alt="Competition" className="img-fluid" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="position-relative m-3">
        <div className="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
          ...
          <div className="row">
            {/* Text Column */}
            <div className="col-md-6 px-0">
              <h1 className="display-4 fst-italic">Flipkart Grid Robotics Challenge</h1>
              <p className="lead my-3">
            ...
            <div className="col-md-6 card-right">
              <div className="d-flex justify-content-center  h-100">
                <img src={flip} alt="Competition" className="ettt" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="position-relative m-3">
        <div className="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
          ...
          <div className="row">
            {/* Text Column */}
            <div className="col-md-6 px-0">
              <h1 className="display-4 fst-italic">FIRA RoboWorld</h1>
              <p className="lead my-3">
            ...
            <div className="col-md-6 card-right">
              <div className="d-flex justify-content-center  h-100">
                <img src={fira} alt="Competition" className="ettt" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="position-relative m-3">
        <div className="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
          ...
          <div className="row">
            {/* Text Column */}
            <div className="col-md-6 px-0">
              <h1 className="display-4 fst-italic">F1-Tenth</h1>
              <p className="lead my-3">
...
F1/10 F1TENTH Autonomous Racing is a semi-regular competition organized by an international community of researchers, engineers, and autonomous systems enthusiasts. The teams participating in 19th F1TENTH Grand Prix at MS 2024 will build a 1:10 scaled autonomous race car according to a given specification and write software for it to fulfill the objectives for the competition: Don’t crash and minimize laptime.
            ...
            <div className="col-md-6 card-right">
              <div className="d-flex justify-content-center  h-100">
                <img src={f1} alt="Competition" className="ettt" />
              </div>
            </div>
          </div>
        </div>
